...
class CategorieController extends AbstractController
{
    ...
    public function modifierCategorie(Request $request, Categorie $categories, EntityManagerInterface $em): Response
    {
        $form = $this->createForm(ModifierCategorieType::class, $categories);
